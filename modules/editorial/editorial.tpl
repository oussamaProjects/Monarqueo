					...
					<div class="info">
						{if $editorial->body_title}
							<div class="title">
								...
								<br>
								{if $editorial->body_subheading} {$editorial->body_subheading|stripslashes} {/if}
							</div>
						{/if} 
						...
						{if $editorial->body_home_logo_link}
							<a href="{$editorial->body_home_logo_link|escape:'html':'UTF-8'}" title="{$editorial->body_title|escape:'html':'UTF-8'|stripslashes}" class="btn btn-black"> 
